...
if __name__ == '__main__':
    file1_path = r'C:\Users\Kan\OneDrive\net_rate.csv'
    file2_path = r'C:\Users\Kan\OneDrive\main_income.csv'
    
    file1 = pd.read_csv(file1_path)
    file2 = pd.read_csv(file2_path)
    topic1 = ['SgnYear', 'AreaName', 'InternetUsers', 'BroadBandSub']
    topic2 = ['年份', '地区', '营业收入/亿元']
    df1 = file1[topic1].iloc[2:]
    df2 = file2[topic2].rename(columns={'年份': 'SgnYear', '地区': 'AreaName', '营业收入/亿元': 'income'})
    ...
    new_file.to_csv('test.csv',encoding='utf-8-sig')
    # print(df1.head())
    # print(df2.head())
    print(new_file.head())
